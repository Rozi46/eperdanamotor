...
class ApiServiceRekappembelianpenjualan
{
    public function rekappembelianpenjualan($request)
    {
        $object = [];
        ...
        if(!$viewadmin){
            ...
            $level_action = LevelAdmin::where('code_data', $viewadmin->level)->where('data_menu','=','rekappembelianpenjualan')->first();
