...
function exportdata(namedata) {
	...
	window.location.href = "/admin/export"+namedata+"?page=1&vd="+encodeURIComponent($('input[id="countvd"]').val())+"&keysearch="+encodeURIComponent($('input[name="key-search"]').val())+searchdate;
}
