<?php
    ...
    $response = app(\App\Services\ApiServicePembayaranpenjualan::class)->viewsalespayment($request);
    ...
    class PDF extends MultiCellTable
    {
        ...
        function Header()
        {
            ...
            $this->SetXY(120,25);
            $this->Cell(30,4,'Sales Order',0);
            $this->Cell(5,4,':');
            $this->Cell(50,4,$d['detail']['nomor_piutang'],0);
            ...
            $this->SetFont('Arial','',9);
            $this->Cell(5);
            $this->Cell(40,5,'Payment From :',0,1);

            $this->SetFont('Arial','B',9);
            $this->Cell(12);
            $this->Cell(0,5,$d['detail_customer']['nama'],0,1);

            $this->SetFont('Arial','',9);
            $this->Cell(12);
            $this->Cell(0,5,$d['detail_customer']['alamat'],0,1);

            $this->Cell(5);
            $this->Cell(40,5,'Phone No',0,0);
            $this->Cell(5,5,':');
            $this->Cell(0,5,$d['detail_customer']['no_telp'],0,1);
        ...
        function DrawSignature()
        {
            ...
            $this->Cell(10);
            $this->Cell(40,5,'Payment By',0,0,'C');
