<html>
    ...
    <body>
        <table class="table_view table-striped table-hover">
            <thead>
                <tr>
                    <td style="text-align:center; padding: 20px; background-color: #FFFFFF; cursor: default; font-weight: 600; font-size: 14px;" colspan="4">Data Rekapitulasi Pembelian dan Penjualan</td>
                </tr>
                <tr>
                    <td style="text-align:center; padding: 20px; background-color: #FFFFFF; cursor: default; font-weight: 600; font-size: 14px;" colspan="4">Tahun {{$listdata['thn_now']}}</td>
                </tr>
                <tr>
