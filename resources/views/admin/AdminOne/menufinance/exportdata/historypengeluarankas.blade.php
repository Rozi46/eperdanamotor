        ...
        <table class="table_view table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th style="width:170px; text-align: center;">No. Pengeluaran Kas</th>
                    <th style="width:150px; text-align: center;">Pengeluaran Kas Oleh</th>
                    <th style="width:170px; text-align: center;">Akun Biaya</th>
            ...
            <tbody>
                <?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
                    <tr>
                        ...
                        <td class="strtable">{{$view_data['jenis']}}</td>
                        <td class="strtable" style="text-align:right;">{{$view_data['nilai']}}</td>
                        <td class="strtable" style="text-align:left;">{{$view_data['keterangan']}}</td>
                    </tr>
                @empty
                    <tr>
