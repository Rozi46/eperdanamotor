        ...
        <table class="table_view table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th style="width:200px; text-align: center;">Pembayaran Pembelian Oleh</th>
                    <th style="width:250px; text-align: center;">Nomor Pembelian</th>
            ...
            <tbody>
                <?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
                    <tr>
                        ...
                        <td class="strtable">{{$view_data['nomor_piutang']}} - [ {{$listdata['detail_customer'][$view_data['code_data']]['nama']}} ]</td>
