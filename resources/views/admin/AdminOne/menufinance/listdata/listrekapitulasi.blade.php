                ...
                <div class="container-fluid text-left">
                    <div class="row">
                        <div class="col-md-12 bg_page_main hd">
                            <div class="col-md-12 hd_page_main">Data Rekapitulasi Pembelian Penjualan</div>
							<div class="col-md-12 bg_act_page_main">
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
										...
										@if($level_user['exportrekappembelianpenjualan'] == 'Yes')<button type="button" class="btn btn-info back" onclick="exportdata('ppn')"><i class="fa fa-download"></i> Export Data</button>@endif
									</div>
								</div>
							</div>
                        </div>
            ...
            @section('script')
                <script type="text/javascript">
                    ...
                    function datafilter() {                        
                        ...
                        window.location.href = "/admin/rekappembelianpenjualan?d={{$request['d']}}&nama_perusahaan="+nama_perusahaan+"&tahun="+tahun;
                    }
                    ...
                    function exportdata() {
                        ...
                        window.location.href = "/admin/exportrekappembelianpenjualan?d={{$request['d']}}&nama_perusahaan="+nama_perusahaan+"&tahun="+tahun;
                    }
                </script>
            @endsection
@endsection