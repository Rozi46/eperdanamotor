								...
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
                                        ...
                                        @if($level_user['historypembayaranpiutang'] == 'Yes')
                                            ...
                                            <a href="printsalespayment?d={{$results['results']['detail']['code_data']}}" target="_blank"><button type="button" class="btn btn-secondary" name="btn_print" btn="print_data"><i class="fa fa-print"></i> Print Pembayaran</button></a>
                                        @endif  
									</div>
								</div>
							</div>
									...
									<div class="row bg_data_page form_page content">
										...
										<div class="col-md-4 bg_form_page">
                                            <div class="form-group row form_input text-left">
                                                ...
                                                <div class="col-sm-6 input">
                                                    <input type="text" name="nomor_penjualan" placeholder="No. Penjualan (SO)" value="" readonly="true">
                                                </div>
                                            </div>
                                        </div>
										<div class="col-md-4 bg_form_page">
			...
			@section('script')
				<script type="text/javascript">
                    $(document).ready(function(){
                        ...
                        $('input[name="nomor_penjualan"]').val('');
                        $('input[name="nama_customer"]').val('');
                        $('input[name="jumlah_piutang"]').val('');
                        ...
                        $('input[name="nomor_penjualan"]').prop({disabled:true});
                        ...
                        $('input[name="nomor_penjualan"]').val('{{ $results['results']['detail']['nomor_piutang'] ?? 'Belum ditentukan' }}');
                        $('input[name="nama_customer"]').val('{{ $results['results']['detail_customer']['nama'] ?? 'Belum ditentukan' }}');
                        $('input[name="jumlah_piutang"]').val('{{ number_format ($results['results']['detail_piutang']['jumlah'] ?? 0,2,",",".") }}');
                        $('input[name="jumlah_bayar"]').val('{{ number_format ($results['results']['jumlah_bayar'] ?? 0,2,",",".") }}');
                        $('input[name="sisa_piutang"]').val('{{ number_format ($results['results']['sisa_piutang'] ?? 0,2,",",".") }}');
