					...
					<div class="row">
						...
						<div class="col-md-12 bg_page_main" line="form_action">
							<div class="col-md-12 data_page">
								<form method="post" name="form_data" enctype="multipart/form-data" action="/admin/newsupplier">
									{{csrf_field()}}
										...
										<div class="col-md-6 bg_form_page">
											<div class="form-group row form_input text-left">
												...
												<div class="col-sm-8 input">
													<input type="text" name="nama" placeholder="Nama Supplier" value="{{ old('nama') }}" autofocus/>
												</div>
											</div>
										</div>                          
                                        <div class="col-md-6 bg_form_page">
