					...
					<div class="row">
							...
							<div class="col-md-12 bg_act_page_main">
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
										...
										@if($level_user['newmerk'] == 'Yes')<button type="button" class="btn btn-primary" name="btn_save" onclick="loadingpage(20000),SaveData('form_data')">Simpan Data</button>@endif
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-12 bg_page_main" line="form_action">
							<div class="col-md-12 data_page">
								<form method="post" name="form_data" enctype="multipart/form-data" action="/admin/newmerk">
									{{csrf_field()}}
										...
										<div class="col-md-12 bg_form_page">
											<div class="form-group row form_input text-left">
												...
												<div class="col-sm-10 input">
													<input type="text" name="nama" placeholder="Nama Merk" value="{{ old('nama') }}" autofocus/>
												</div>
											</div>
										</div>
									</div> 
