					...
					<div class="row">
							...
							<div class="col-md-12 bg_act_page_main">
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
										...
										@if($level_user['newgudang'] == 'Yes')<button type="button" class="btn btn-primary" name="btn_save" onclick="loadingpage(20000),SaveData('form_data')">Simpan Data</button>@endif
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-12 bg_page_main" line="form_action">
							<div class="col-md-12 data_page">
								<form method="post" name="form_data" enctype="multipart/form-data" action="/admin/newgudang">
									{{csrf_field()}}
									<div class="row bg_data_page form_page content">
										<div class="col-md-6 bg_form_page">
											<div class="form-group row form_input text-left">
												...
												<div class="col-sm-8 input">
													<input type="text" name="nama" placeholder="Nama Gudang" value="{{ old('nama') }}" autofocus/>
												</div>
											</div>
										</div>
										<div class="col-md-6 bg_form_page">
										...
										<div class="col-md-6 bg_form_page">
                                            <div class="form-group row form_input text-left">
                                                ...
                                                <div class="col-sm-8 input">
                                                    <select name="jenis_gudang" placeholder="Jenis Gudang"  value=>								
			...
			@section('script')
                <script type="text/javascript">
                    $(document).ready(function(){
                        $('select[name="jenis_gudang"] option[value="Cabang"]').prop("selected", true); 
					});
                </script>
            @endsection
@endsection