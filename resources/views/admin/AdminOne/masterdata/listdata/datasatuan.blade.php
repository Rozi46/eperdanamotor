                ...
                <div class="container-fluid text-left">
                    <div class="row">
                        <div class="col-md-12 bg_page_main hd">
                            <div class="col-md-12 hd_page_main">Data Satuan</div>
							<div class="col-md-12 bg_act_page_main">
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
										...
										@if($level_user['newsatuan'] == 'Yes')<a load="true" href="/admin/newsatuan"><button type="button" class="btn btn-primary">Tambah Data</button></a>@endif
										
										@if($level_user['exportsatuan'] == 'Yes')<button type="button" class="btn btn-info back" onclick="exportdata('listsatuan')"><i class="fa fa-download"></i> Export Data</button>@endif
									</div>
								</div>
							</div>
                        </div>
										...
										<table class="table_view table-striped table-hover">
											<thead>
												<tr>
													...
													<th style="min-width:60px; text-align: center;">Kode Data</th>
													<th style="min-width:200px; text-align: center;">Nama Satuan</th>
													<th style="min-width:50px; text-align: center;">Isi Satuan</th>
													<th style="min-width:150px; text-align: center;">Pecahan Satuan</th>
											...
											<tbody>
												<?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
																...
																if($('[btn="del_data_{{$view_data['id']}}"]').click){
																	...
																	$('button[btn-action="aciton-confirmasi"]').click(function(){
																		if($('button[btn-action="aciton-confirmasi"]').click){
																			loadingpage(20000);
																			window.location.href = "/admin/deletesatuan?d={{$view_data['id']}}";
																		}
																	});
																}
															});
													...
													<tr>
														...
														<td style="text-align:center;">{{$view_data['isi']}} </td>
														<td>{{$pecahansatuan}}</td>
														<td class="colright" style="text-align:center;">
															<div class="dropdown dropleft">
																...
																<div class="dropdown-menu">
																	...
																	<a load="true" class="dropdown-item" href="editsatuan?d={{$view_data['id']}}">Lihat/Ubah Data</a>
																	<a class="dropdown-item @if($listdata['count_used'][$view_data['id']] > 0) disabled @endif @if($level_user['deletesatuan'] == 'No') disabled @endif" <?php if($listdata['count_used'][$view_data['id']] == 0){ if($level_user['deletesatuan'] == 'Yes'){ ?> btn="del_data_{{$view_data['id']}}"<?php } }?>>Hapus Data</a>
																</div>
															</div>
														</td>
													</tr>
