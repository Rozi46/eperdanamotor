                ...
                <div class="container-fluid text-left">
                    <div class="row">
                        <div class="col-md-12 bg_page_main hd">
                            <div class="col-md-12 hd_page_main">Data Kategori</div>
																...
																if($('[btn="del_data_{{$view_data['id']}}"]').click){
																	...
																	$('button[btn-action="aciton-confirmasi"]').click(function(){
																		if($('button[btn-action="aciton-confirmasi"]').click){
																			loadingpage(20000);
																			window.location.href = "/admin/deletekategori?d={{$view_data['id']}}";
																		}
																	});
																}
															});
														...
														<td class="colright" style="text-align:center;">
															<div class="dropdown dropleft">
																...
																<div class="dropdown-menu">
																	...
																	<a load="true" class="dropdown-item" href="editkategori?d={{$view_data['id']}}">Lihat/Ubah Data</a>
																	<a class="dropdown-item @if($listdata['count_used'][$view_data['id']] > 0) disabled @endif @if($level_user['deletekategori'] == 'No') disabled @endif" <?php if($listdata['count_used'][$view_data['id']] == 0){ if($level_user['deletekategori'] == 'Yes'){ ?> btn="del_data_{{$view_data['id']}}"<?php } }?>>Hapus Data</a>
																</div>
															</div>
														</td>
													</tr>
