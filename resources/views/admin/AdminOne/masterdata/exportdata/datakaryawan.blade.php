        ...
        <table class="table_view table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th style="width:400px; text-align: center;">Tempat, Tgl Lahir</th>
                    <th style="width:150px; text-align: center;">Jenis Kelamin</th>
                    <th style="width:400px; text-align: center;">Jabatan</th>
            ...
            <tbody>
                <?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
                    <tr>
						...
						<td class="strtable" >{{$view_data['tempat_lahir']}}, {{Date::parse($view_data['tanggal_lahir'])->format('j F Y')}}</td>
						<td class="strtable" style="text-align:center;">{{$view_data['jenis_kelamin']}}</td>
						<td class="strtable" >{{$view_data['jabatan']}}</td>
						<td class="strtable" style="text-align:center;">{{$view_data['no_hp']}}</td>
