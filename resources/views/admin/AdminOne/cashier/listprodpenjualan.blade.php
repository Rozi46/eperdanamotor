<?php $no = 0;?> @forelse($results['results']['list_produk'] as $view_data) <?php $no++ ;?>
    ...
    <script>
        $(document).ready(function(){      
            ...
            $('[btn="del_produk_{{$view_data['id']}}"]').click(function(){
                if($('[btn="del_produk_{{$view_data['id']}}"]').click){
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/cash/deleteprodpenjualan?_token={{csrf_token()}}&token={{$request['token']}}&u={{$request['u']}}",
                        ...
                        success: function(data){
                            if(data.status_message == 'success'){
                                ...
                                $.get("/cash/listprodpenjualan",{code_data:"{{$view_data['nomor']}}"},function(listproduk){
                                ...
                                $.get("/cash/summarypenjualan",{code_data:'{{$results['results']['detail']['nomor']}}'},function(listsummary){
        ...
        function listsatuanharga_<?php echo $id;?>(){       
            ...
            $.ajax({
                type: "GET",
                url: "/cash/listsatuanhargapenjualan?_token={{csrf_token()}}&token={{$request['token']}}&u={{$request['u']}}",
        ...
        function saveprice_<?php echo $id;?>(){
            ...
            $.ajax({
                type: "POST",
                url: "/cash/uphargapenjualan?_token={{csrf_token()}}&token={{$request['token']}}&u={{$request['u']}}",
        ...
        function saveqty_<?php echo $id;?>(){
            ...
            $.ajax({
                type: "POST",
                url: "/cash/upqtypenjualan?_token={{csrf_token()}}&token={{$request['token']}}&u={{$request['u']}}",
        ...
        function savedisc_<?php echo $id;?>(){
            ...
            $.ajax({
                type: "POST",
                url: "/cash/updiscpenjualan?_token={{csrf_token()}}&token={{$request['token']}}&u={{$request['u']}}",
        ...
        function savedisc2_<?php echo $id;?>(){
            ...
            $.ajax({
                type: "POST",
                url: "/cash/updiscpenjualan2?_token={{csrf_token()}}&token={{$request['token']}}&u={{$request['u']}}",
