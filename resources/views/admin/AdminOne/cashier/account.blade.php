									...
									<div class="row bg_data_page form_page content">
										...
										<div class="col-md-6 bg_form_page">
											<div class="form_input text-left">
                                                ...
                                                <img src="<?php if( $res_user['image'] == 'no_img'){echo asset('/image/no_image.jpg'); }else{echo asset('/image/upload/'.$res_user['image'].'');}?>" alt="User" srcimg="image_admin" onclick="OpenFile('form_data','image_admin')">
