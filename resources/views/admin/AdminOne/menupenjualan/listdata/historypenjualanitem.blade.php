							...
							<div class="col-md-12 bg_act_page_main">
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
										...
										@if($level_user['inputpenjualanbarang'] == 'Yes')<a href="/admin/menupenjualanbarang"><button type="button" class="btn btn-primary">Input Penjulaan</button></a>@endif
												...
												<?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
													<script>
														function viewdata_{{$no}}() {
															loadingpage(2000);
															window.location.href = "/admin/viewpenjualan?d={{$listdata['detail_penjualan'][$view_data['id']]['nomor']}}";
														}
													</script>
													<tr>
