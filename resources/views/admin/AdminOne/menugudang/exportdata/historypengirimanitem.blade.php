            ...
            <tbody>
                <?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
                    <tr>
                        ...
                        <td class="strtablek" style="text-align:center;" >{{$view_data['nomor_pengiriman']}}</td>
                        <td>{{$listdata['detail_penjualan'][$view_data['id']]['nomor']}}</td>
                        <td>{{$listdata['detail_barang'][$view_data['id']]['nama']}}</td>
                        <td style="text-align:center;">{{$listdata['qty_pengiriman'][$view_data['id']]['jumlah_kirim']}}</td>
