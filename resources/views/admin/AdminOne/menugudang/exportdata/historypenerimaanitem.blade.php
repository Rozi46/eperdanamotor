            ...
            <tbody>
                <?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
                    <tr>
                        ...
                        <td class="strtablek" style="text-align:center;" >{{$view_data['nomor_penerimaan']}}</td>
                        <td>{{$listdata['detail_pembelian'][$view_data['id']]['nomor']}}</td>
                        <td>{{$listdata['detail_barang'][$view_data['id']]['nama']}}</td>
                        <td style="text-align:center;">{{$listdata['qty_penerimaan'][$view_data['id']]['jumlah_terima']}}</td>
