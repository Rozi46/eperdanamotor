        ...
        <table class="table_view table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th style="width:170px; text-align: center;">No. Mutasi Terima</th>
                ...
                <?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
                    <tr>
                        ...
                        <td class="strtable" style="text-align:center;">
                            {{ $listdata['detail_mutasi'][$view_data['code_data']]['nomor'] != 'null' ? $listdata['detail_mutasi'][$view_data['code_data']]['nomor'] : 'Belum Ditentukan' }}
                        </td>
                        ...
                        <td class="strtable" style="text-align:center;">
                            {{ $listdata['detail_gudang_asal'][$view_data['code_data']]['nama'] != 'null' ? $listdata['detail_gudang_asal'][$view_data['code_data']]['nama'] : 'Belum Ditentukan' }}
                        </td>
                        <td class="strtable" style="text-align:center;">
                            {{ $listdata['detail_gudang_tujuan'][$view_data['code_data']]['nama'] != 'null' ? $listdata['detail_gudang_tujuan'][$view_data['code_data']]['nama'] : 'Belum Ditentukan' }}
                        </td>
                        <td class="strtable" style="text-align:center;">{{$view_data['ket']}}</td>
                        <td class="strtable" style="text-align:center;">
                            {{ $listdata['detail_mutasi'][$view_data['code_data']]['status_transaksi'] != 'null' ? $listdata['detail_mutasi'][$view_data['code_data']]['status_transaksi'] : 'Belum Ditentukan' }}
                        </td>
                    </tr>
                @empty
                    <tr>
