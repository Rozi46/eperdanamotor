							...
							<div class="col-md-12 bg_act_page_main">
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
										...
										@if($level_user['inputmutasiterima'] == 'Yes')<a href="/admin/mutasikirim"><button type="button" class="btn btn-primary">Input Mutasi Terima</button></a>@endif
										...
										<table class="table_view table-striped table-hover">
											<thead>
												<tr>
													...
													<th style="min-width:125px; text-align: center;">Qty Terima</th>
											...
											<tbody>
												<?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>				
													...
													<tr>
														...
														<td style="text-align:center;">{{ number_format($listdata['qty_terima'][$view_data['id']] ?? 0,0,",",".") }} {{ $listdata['detail_satuan'][$view_data['id']]['nama'] ?? 'Belum ditentukan' }}</td>
														<td>{{ $listdata['detail_gudang_asal'][$view_data['id']]['nama'] ?? 'Belum ditentukan' }}</td>
														<td>{{ $listdata['detail_gudang_tujuan'][$view_data['id']]['nama'] ?? 'Belum ditentukan' }}</td>
