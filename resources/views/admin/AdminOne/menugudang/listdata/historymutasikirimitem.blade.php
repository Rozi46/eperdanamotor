										...
										<table class="table_view table-striped table-hover">
											<thead>
												<tr>
													...
													<th style="min-width:170px; text-align: center;">Nama Barang</th>
													<th style="min-width:125px; text-align: center;">Qty Kirim</th>
											...
											<tbody>
												<?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>				
													...
													<tr>
														...
														<td style="text-align:left;">{{ $listdata['user_input'][$view_data['id']]['full_name'] ?? 'Belum ditentukan' }}</td>
														<td style="text-align:left;">{{ $listdata['detail_barang'][$view_data['id']]['nama'] ?? 'Belum ditentukan' }}</td>
														<td style="text-align:center;">{{ number_format($view_data['qty'] ?? 0,0,",",".") }} {{ $listdata['detail_satuan'][$view_data['id']]['nama'] ?? 'Belum ditentukan' }}</td>
														<td>{{ $listdata['detail_gudang_asal'][$view_data['id']]['nama'] ?? 'Belum ditentukan' }}</td>
														<td>{{ $listdata['detail_gudang_tujuan'][$view_data['id']]['nama'] }}</td>
