										...
										<table class="table_view table-striped table-hover">
											<thead>
												<tr>
													...
													<th style="width:200px; text-align: center;">No. Penjualan</th>
											...
											<tbody>
												<?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
													...
													<tr>
                                                        ...
                                                        <td>{{ $listdata['detail_penjualan'][$view_data['id']]['nomor'] ?? 'Belum Ditentukan' }}</td>
                                                        <td>{{ $listdata['detail_barang'][$view_data['id']]['nama'] ?? 'Belum Ditentukan'}}</td>
														<td style="text-align:center;">{{ number_format($listdata['qty_pengiriman'][$view_data['id']]['jumlah_kirim'] ?? 0,0,"",".") }}</td>
