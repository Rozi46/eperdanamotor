										...
										<table class="table_view table-striped table-hover">
											<thead>
												<tr>
													...
													<th style="width:200px; text-align: center;">No. Pembelian</th>
                                                    <th style="min-width:175px; text-align: center;">Nama Barang</th>
												...
												<?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
													...
													<tr>
														<td style="text-align:center;">{{$no}}
                                                            <br/><?php if($res_user['level'] == 'LV5677001'){?> <i class="fa fa-building" title="{{ $listdata['detail_perusahaan'][$view_data['id']]['kantor'] ?? 'Belum Ditentukan' }} | {{ $listdata['detail_cabang'][$view_data['id']]['nama_cabang'] ?? 'Belum Ditentukan' }}"></i><?php } ?>
                                                        </td>
                                                        ...
                                                        <td>{{ $listdata['detail_pembelian'][$view_data['id']]['nomor'] ?? 'Belum Ditentukan'}}</td>
                                                        <td>{{ $listdata['detail_barang'][$view_data['id']]['nama'] ?? 'Belum Ditentukan'}}</td>
														<td style="text-align:center;">{{ number_format($listdata['qty_penerimaan'][$view_data['id']]['jumlah_terima'] ?? 0,0,"",".") }}</td>
                                                        <td>{{ $listdata['detail_gudang'][$view_data['id']]['nama'] ?? 'Belum Ditentukan'}}</td>
                                                        <td>{{ $listdata['detail_supplier'][$view_data['id']]['nama'] ?? 'Belum Ditentukan'}}</td>
													</tr>
												@empty
													<tr>
