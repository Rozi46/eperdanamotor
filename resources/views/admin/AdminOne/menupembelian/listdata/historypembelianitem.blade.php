										...
										<table class="table_view table-striped table-hover">
											<thead>
												<tr>
													...
													<th class="colleft" style="min-width:150px; text-align: center;">No. Pembelian</th>
													<th style="min-width:150px; text-align: center;">Nama Supplier</th>
													<th style="min-width:250px; text-align: center;">Nama Barang</th>
													<th style="min-width:110px; text-align: center;">Qty Pembelian</th>
													<th style="min-width:100px; text-align: center;">Qty Diterima</th>
													<th style="min-width:120px; text-align: center;">Harga Beli</th>
												...
												<?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
													<script>
														function viewdata_{{$no}}() {
															loadingpage(2000);
															window.location.href = "/admin/viewpembelian?d={{$listdata['detail_pembelian'][$view_data['id']]['nomor']}}";
														}
													</script>
													<tr>
														<td style="text-align:center;">{{$no}}
															<br/><?php if($res_user['tipe_user'] == 'Super User'){?> <i class="fa fa-building" title="{{ $listdata['detail_perusahaan'][$view_data['id']]['kantor'] ?? 'Belum Ditentukan' }} | {{ $listdata['detail_cabang'][$view_data['id']]['nama_cabang'] ?? 'Belum Ditentukan' }}"></i><?php } ?>
                                                        </td>
														...
														<td style="text-align:center;">{{ number_format($view_data['jumlah_beli'] ?? 0,0,"",".") }} {{ $listdata['satuan_prod'][$view_data['id']]['nama'] ?? 'Belum Ditentukan' }}</td>
                                                        <td style="text-align:center;">{{ number_format($view_data['jumlah_terima'] ?? 0,0,"",".") }} {{ $listdata['satuan_prod'][$view_data['id']]['nama'] ?? 'Belum Ditentukan' }}</td>
